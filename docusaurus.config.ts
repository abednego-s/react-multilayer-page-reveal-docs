...
const config: Config = {
  ...
  themeConfig: {
    ...
    navbar: {
      title: "react-multilayer-page-reveal",
      logo: {
        alt: "react-multilayer-page-reveal",
        src: "img/logo.svg",
      },
      items: [
        {
        ...
        {
          href: "https://github.com/abednego-s/react-multilayer-page-reveal",
          label: "GitHub",
          position: "right",
        },
      ],
    ...
    footer: {
      ...
      copyright: `Copyright © ${new Date().getFullYear()} Intensify Labs. Built with Docusaurus.`,
    },
    prism: {
